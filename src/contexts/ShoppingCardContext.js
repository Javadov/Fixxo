...
export const ShoppingCartProvider = ({children}) => {
    ...
    const getItemSummary = (articleNumber) => {
        return cartItems.find(item => item.articleNumber === articleNumber)?.price
    }
    ...
    return <ShoppingCartContext.Provider value= {{cartItems, cartQuantity, cartSummary, getItemQuantity, getItemSummary, incrementQuantity, decrementQuantity, removeItem}}>
        {children}
        <ShoppingCart />
